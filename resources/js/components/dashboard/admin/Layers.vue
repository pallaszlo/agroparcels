      ...
      <v-card>
        ...
        <v-card-text>
          <v-container>
            ...
            <layers-map :coordinates="showedItem.coordinates" :name="`edit`" :editActive="true" :drawActive="false" :resetBtn="true" @update:coordinates ="(newCoords) => {this.showedItem.coordinates = newCoords;}"/>
          </v-container>
        </v-card-text>
        <v-card-actions>
...
export default {
  ...
  data() {
    return {
        ...
        { text: "Parcella név", value: "parcel_name", groupable: true},
        {text: "Kultúra név", value: "culture_name", groupable: true},
        { text: "Elvégzett munkák", value: "works_count"},
